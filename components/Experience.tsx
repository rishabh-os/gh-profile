      ...
      >
        ...
        <ol className="line">
          ...
          <li className="explist">
            ...
            <h3 className="title">
              Analysis of Gravitational Wave Data using Machine Learning, under
              Anupreeta More, IUCAA, Pune
            </h3>
            <p className="description">
              Using unsupervised machine learning algorithms to identify and
              classify different types of signals in LIGO data using bicoherence
              maps of the signals as the input.
            </p>
          </li>
          <li className="explist">
            <div className="topdiv"></div>
            ...
            <h3 className="title">
              Applicaitions of Machine Learning in quantum Information, under T.
              S. Mahesh, IISER, Pune
            </h3>
            <p className="description">
          ...
          <li className="explist">
            ...
            <p className="description">
              Worked on setting up and eliminating noise from antennas to record
              radiation from the night sky. This was done by using the Lecher
              Wire as a basis.
            </p>
          </li>
          <li className="explist">
            ...
            <h3 className="title">
              N-Body Simulations and Analysis, under Najam Hassan, University of
              Osmania
            </h3>
            <p className="description">
      ...
      >
        ...
        <ol className="line">
          <li className="explist">
            ...
            <h3 className="title">BS-MS Dual Degree in Physics, IISER, Pune</h3>
